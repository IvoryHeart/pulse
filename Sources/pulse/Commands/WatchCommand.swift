...
enum WatchCommand {
    ...
    private static func renderFrame(
        ...
        score: HealthScore, procs: [PulseProcessInfo],
        ...
        let header = "  \(TerminalUI.colored("pulse watch", .boldCyan))  Health: \(TerminalUI.colored("\(score.score)/100", scoreColor)) \(scoreBar) \(TerminalUI.colored(score.rating, scoreColor))"
        lines.append(header)
        lines.append("")
