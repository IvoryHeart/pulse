...
public struct ProcessMonitor {
    ...
    public static func getTopProcesses(sortBy: SortCriteria = .cpu, limit: Int = 10) -> [HKProcessInfo] {
    ...
    private static func parsePSLine(_ line: String) -> HKProcessInfo? {
