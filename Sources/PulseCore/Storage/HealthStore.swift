...
public final class HealthStore {
    ...
    public func open() throws {
        ...
        guard sqlite3_open(path, &db) == SQLITE_OK else {
            throw PulseStoreError.cannotOpen(String(cString: sqlite3_errmsg(db)))
        }
        try createTables()
    }
    ...
    private func saveProcess(snapshotId: Int64, process: PulseProcessInfo) throws {
...
public enum PulseStoreError: Error, LocalizedError {
